...
- [~] **Phase 4 — Rust core (the speed blocker):** IN PROGRESS — Stage A done 2026-06-29.
      ...
      - [ ] parallelize the 4 maps + CTR blocks + benchmark vs AES/ChaCha. [ ] port the auto-rekey
            ratchet (needs HMAC-SHA512 + zeroize in Rust) + extend KAT parity to it. [ ] fuzz Rust==KAT.
